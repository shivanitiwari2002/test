//=============================================================================
//* Name:         ArtifactRelationshipRepository.java
//*
//* Application:  System DevOps Bridge-Interceptor eXtreme (BrIX) REST
//*
//* Module Name:  BrIX ArtifactRelationshipRepository
//*
//* Description:  This class provides access to ArtifactRelationship in the DB.
//*
...
//* ---- -------- -------- --------  ------------------------------------------
//*               20250603 tollefso  New source file created.
//*
...
@ApplicationScoped
public class ArtifactRelationshipRepository implements PanacheRepository<ArtifactRelationship> {

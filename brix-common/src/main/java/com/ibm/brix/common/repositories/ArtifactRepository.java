//=============================================================================
//* Name:         ArtifactRepository.java
//*
//* Application:  System DevOps Bridge-Interceptor eXtreme (BrIX) REST
//*
//* Module Name:  BrIX ArtifactRepository
//*
//* Description:  This class provides access to Artifacts in the DB.
//*
...
//* ---- -------- -------- --------  ------------------------------------------
//*               20250430 tollefso  New source file created.
//*

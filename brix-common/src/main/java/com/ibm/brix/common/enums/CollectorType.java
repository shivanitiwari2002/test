//=============================================================================
//* Name:         CollectorType.java
//*
//* Application:  System DevOps Bridge-Interceptor eXtreme (BrIX)
//*
//* Module Name:  BrIX Collector Type Enumeration
//*                                                                
//* Description:  This enumeration lists the ways BrIX can be notified of
...
public enum CollectorType {
    ...
    private String name;
    private static final Map<String, CollectorType> ENUM_MAP;

    // Build an immutable map of String name to enum pairs
    static {
        Map<String,CollectorType> map = new HashMap<String,CollectorType>();
        for (CollectorType instance : CollectorType.values()) {
    ...
    public static CollectorType get(String name) {
